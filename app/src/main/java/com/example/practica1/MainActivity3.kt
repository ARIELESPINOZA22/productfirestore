        ...
        db.collection("products")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    Toast.makeText(this, "No se encontraron productos para la categoría seleccionada", Toast.LENGTH_SHORT).show()
                } else {
            ...
            Toast.makeText(this, "Error al recuperar los productos: ${e.message}", Toast.LENGTH_LONG).show()
        }
    }
}
